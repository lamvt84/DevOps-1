...
BEGIN
    ...
    BEGIN
        ...
        ('BROKER_TRANSMITTER', 'Service Broker', 0),
        ('CHECKPOINT_QUEUE', 'Idle', 0),
        ('CHKPT', 'Tran Log IO', 0),
        ('CLR_AUTO_EVENT', 'SQL CLR', 0),
        ('CLR_CRST', 'SQL CLR', 0),
        ('CLR_JOIN', 'SQL CLR', 0),
        ('CLR_MANUAL_EVENT', 'SQL CLR', 0),
        ...
        ('PARALLEL_REDO_DRAIN_WORKER', 'Replication', 0),
        ('PARALLEL_REDO_FLOW_CONTROL', 'Replication', 0),
        ('PARALLEL_REDO_LOG_CACHE', 'Replication', 0),
        ('PARALLEL_REDO_TRAN_LIST', 'Replication', 0),
        ('PARALLEL_REDO_TRAN_TURN', 'Replication', 0),
        ('PARALLEL_REDO_WORKER_SYNC', 'Replication', 0),
        ('PARALLEL_REDO_WORKER_WAIT_WORK', 'Replication', 0),
        ...
        ('REDO_THREAD_PENDING_WORK', 'Other', 0),
