IF EXISTS (SELECT 1/0 FROM sys.server_event_sessions WHERE name = 'KV_DeadlockLog')
    DROP EVENT SESSION [KV_DeadlockLog] ON SERVER 
    
CREATE EVENT SESSION [KV_DeadlockLog] ON SERVER
