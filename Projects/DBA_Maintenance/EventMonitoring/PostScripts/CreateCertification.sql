:Setvar CertName "EventMonitoringCertificate"
:Setvar CertPath "C:\Cert\"
:Setvar CertEncryptPass "C1t1g000$6162Locks"
...
IF EXISTS (
    ...
    WHERE obj.name = 'pr_ProcessBlockProcessReports'
)
    DROP SIGNATURE FROM OBJECT::[dbo].[sp_ProcessBlockProcessReports] BY CERTIFICATE [$(CertName)]

ADD SIGNATURE TO OBJECT::[dbo].[sp_ProcessBlockProcessReports]
